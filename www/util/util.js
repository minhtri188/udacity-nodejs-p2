...
exports.getFilesFromPath = exports.deleteLocalFiles = exports.filterImageFromURL = void 0;
...
function getFilesFromPath() {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                const fullPath = __dirname + "/tmp";
                const files = yield fs_1.default.readdirSync(fullPath).map((file) => {
